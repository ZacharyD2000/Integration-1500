...
main_one = int(input("Enter the number corresponding to the calculator you would like to use: "))
...
#number of cards being sampled
        cards = 52
        print("This calculator is used to find the probability that you choose a certain card within a standard deck of cards.")
...
def perm():
    loop_one = 1
    while loop_one >= 0:
        n_variable_one = int(input("Please enter the n variable that comes before the P for permutation. "))
        k_variable_one = int(input("Please enter the k variable that comes after the P for permutation. "))
...
def combination():
    ...
    while loop_two > 0:
        ...
        n_variable_two = int(input("Please enter the n variable that comes before the C for Combination. "))
        k_variable_two = int(input("Please enter the k variable that comes after the C for Combination. "))
...
def quiz():
    ...
    if answer_q1 == "a":
        ...
        print("Sorry that was not the correct answer, it was actually 980179200")
        print("Score =", score)
...
def main():
    if main_one == 1:
        cards_tested = int(input("Please enter total number of cards that fit within the given requirement. "))
